...
namespace Unity.FPS.Gameplay
{
    public class ProjectileChargeParameters : MonoBehaviour
    {
        ...
        public MinMaxFloat StunDuration;
        ...
        void OnShoot()
        {
            ...
            if (proj)
            {
                ...
                if (proj.AreaOfDamage)
                {
                    proj.AreaOfDamage.AreaOfEffectDistance = AreaOfEffectDistance.GetValueFromRatio(m_ProjectileBase.InitialCharge);
                }
                proj.StunDuration = StunDuration.GetValueFromRatio(m_ProjectileBase.InitialCharge);
            }
        }
    }
}