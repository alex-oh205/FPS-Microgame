...
namespace Unity.FPS.UI
{
    ...
    public class AmmoCounter : MonoBehaviour
    {
        ...
        public void Initialize(WeaponController weapon, int weaponIndex)
        {
            ...
            DebugUtility.HandleErrorIfNullFindObject<PlayerWeaponsManager, AmmoCounter>(m_MainWeaponsManager, this);
        ...
        void Update()
        {
            ...
            bool isActiveWeapon = m_Weapon == m_MainWeaponsManager.GetActiveWeapon();
