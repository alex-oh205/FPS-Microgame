...
namespace Unity.FPS.UI
{
    public class CrosshairManager : MonoBehaviour
    {
        ...
        PlayerWeaponsManager[] m_WeaponsManagers;
        ...
        void Start()
        {
            m_WeaponsManagers = GameObject.FindObjectsOfType<PlayerWeaponsManager>();
            foreach (var weaponsManager in m_WeaponsManagers)
            {
            ...
            DebugUtility.HandleErrorIfNullFindObject<PlayerWeaponsManager, CrosshairManager>(m_MainWeaponsManager, this);

            OnWeaponChanged(m_MainWeaponsManager.GetActiveWeapon());

            m_MainWeaponsManager.OnSwitchedToWeapon += OnWeaponChanged;
        }

        void Update()
        {
            UpdateCrosshairPointingAtEnemy(false);
            m_WasPointingAtEnemy = m_MainWeaponsManager.IsPointingAtEnemy;
        }
        ...
        void UpdateCrosshairPointingAtEnemy(bool force)
        {
            ...
            if ((force || !m_WasPointingAtEnemy) && m_MainWeaponsManager.IsPointingAtEnemy)
            {
            ...
            else if ((force || m_WasPointingAtEnemy) && !m_MainWeaponsManager.IsPointingAtEnemy)
            {
