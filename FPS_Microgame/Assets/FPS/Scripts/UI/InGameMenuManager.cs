...
namespace Unity.FPS.UI
{
    public class InGameMenuManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_URPAsset = (UniversalRenderPipelineAsset) GraphicsSettings.defaultRenderPipeline;
            ...
            ShadowsToggle.isOn = m_URPAsset.shadowDistance != 0f;
        ...
        {
            m_URPAsset.shadowDistance = newValue ? shadowDist : 0f;
        }
