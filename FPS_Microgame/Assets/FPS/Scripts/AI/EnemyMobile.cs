...
namespace Unity.FPS.AI
{
    ...
    public class EnemyMobile : MonoBehaviour
    {
        ...
        void UpdateCurrentAiState()
        {
            ...
            switch (AiState)
            {
                case AIState.Patrol:
                    ...
                    m_EnemyController.NavMeshAgent.stoppingDistance = 0.2f;
                    break;
                case AIState.Follow:
                    m_EnemyController.SetNavDestination(m_EnemyController.KnownDetectedTarget.transform.position);
                    m_EnemyController.OrientTowards(m_EnemyController.KnownDetectedTarget.transform.position);
                    m_EnemyController.OrientWeaponsTowards(m_EnemyController.KnownDetectedTarget.transform.position);
                    m_EnemyController.NavMeshAgent.stoppingDistance = (m_EnemyController.NavMeshAgent.agentTypeID == 0) ? 0.2f : 10f;
                    break;
                case AIState.Attack:
        ...
        void OnLostTarget()
        {
            ...
            if (AiState == AIState.Follow || AiState == AIState.Attack || AiState == AIState.Stunned)
            {
                AiState = AIState.Patrol;
            }
