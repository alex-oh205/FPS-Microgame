...
namespace Unity.FPS.AI
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        float m_LastTimeStunned = float.NegativeInfinity;
        ...
        void Update()
        {
            ...
            if (IsStunned)
            {
                if (Time.time - m_LastTimeStunned > m_StunDuration)
                {
                    IsStunned = false;
                }
            }
        ...
        void OnDamaged(float damage, GameObject damageSource, bool stun, float stunDuration)
        {
            ...
            if (damageSource && !damageSource.GetComponent<EnemyController>())
            {
                ...
                if (DetectionModule)
                {
                    DetectionModule.OnDamaged(gameObject, damageSource);
                }
